function [cepstra,aspectrum,pspectrum, binfreqs] = melfcc(samples, sr, varargin)
...
[aspectrum wts binfreqs] = audspec(pspectrum, sr, nbands, fbtype, minfreq, maxfreq, sumpower, bwidth);
